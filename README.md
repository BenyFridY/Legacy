...
```bat
:: suíte completa com fakes -> espere "243 passed" em poucos segundos
python -m pytest -q
...
Os **243 testes** rodam em segundos e provam o **fluxo e as recusas** com modelos **falsos** (encoder/
